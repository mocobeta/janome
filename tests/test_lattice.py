...
class TestLattice(unittest.TestCase):
    ...
    def test_backward(self):
        ...
        self.assertEqual('すもも', min_cost_path[1].entry.surface)
        self.assertEqual('も', min_cost_path[2].entry.surface)
        self.assertEqual('もも', min_cost_path[3].entry.surface)
        self.assertEqual('も', min_cost_path[4].entry.surface)
        self.assertEqual('もも', min_cost_path[5].entry.surface)
        self.assertEqual('の', min_cost_path[6].entry.surface)
        self.assertEqual('うち', min_cost_path[7].entry.surface)
